...
const timelineEntries: TimelineEntry[] = [
  { time: "2:30 PM", label: "Florals delivered — ballroom", meta: "Bloom & Co." },
  {
    time: "3:15 PM",
...
function ValueCell({ cell }: { cell: ComparisonCell }) {
  if (cell.kind === "price") {
    return (
      <td className={styles.cell}>
        <span
          className={cell.tone === "muted" ? styles.priceMuted : styles.priceSoft}
        >
          {cell.lead}
          <b>{cell.amount}</b>
          {cell.trail}
  ...
  return (
    <td className={included ? styles.cell : `${styles.cell} ${styles.cellAbsent}`}>
      <span
    ...
    <div className={styles.page}>
      ...
      <section className={styles.hero}>
        <div className={styles.heroCopy}>
          ...
          <p className={styles.heroLede}>
            ...
            planners, venues, caterers, florists and photographers. Gatherwise is
            planning and sales software built for one job only: the way event and
            wedding planners work today.
          </p>
        ...
        <div className={styles.preview}>
          <div className={styles.previewHead}>
            <div className={styles.previewTitle}>Harper &amp; Cole — Day Of</div>
            ...
            {timelineEntries.map((entry) => (
              ...
              >
                ...
                <span className={styles.previewBody}>
                  ...
                  <span
                    className={
                      entry.moving ? styles.previewMetaActive : styles.previewMeta
                    }
                  >
                    {entry.meta}
                  </span>
      ...
      <section className={styles.positioning}>
        <div className={styles.wide}>
          ...
          <p className={styles.positioningLede}>
            Neither is wrong. It comes down to whether you want a platform for the
            whole events industry, or software shaped around your work alone.
          </p>
          <div className={styles.positioningGrid}>
            <div className={styles.posCard}>
              ...
              <p className={styles.posText}>
                Built narrow on purpose. Timelines, tasks, proposals, invoicing,
                seating — every screen assumes you are a planner running client
                events.
              </p>
            ...
            <div className={`${styles.posCard} ${styles.posCardAlt}`}>
              ...
              <p className={styles.posText}>
                A well-known name for years. It serves planners alongside venues,
                caterers, florists and photographers — real breadth, and an
                advantage for those businesses.
              </p>
              <ul className={styles.posList}>
                {[
        ...
        <div className={styles.narrow}>
          ...
          <table className={styles.table}>
            <caption className={styles.srOnly}>
              Gatherwise and Aisle Planner capabilities compared, grouped by area.
            </caption>
            <colgroup>
      ...
      <section className={styles.aisleFit}>
        <div className={styles.aisleFitCard}>
          <div className={styles.eyebrow}>Where Aisle Planner may fit better</div>
          <h2 className={styles.aisleFitTitle}>
            We would rather you pick the right tool than pick us.
          </h2>
          <p className={styles.aisleFitText}>
            If a long-established name matters to you, Aisle Planner has earned
            it. Their design and floor-plan tools are genuinely mature, and
            because they also build for venues, caterers, florists and
            photographers, a planner who runs one of those businesses alongside
            their planning work can keep everything on a single platform. Those
            are good reasons to choose them, and we will say so.
          </p>
        ...
        <div className={styles.narrow}>
          ...
          <div className={styles.pricingCard}>
            ...
            <div className={styles.chart}>
              <div className={styles.chartColumn}>
                ...
                <span className={styles.chartLabel}>
                  ...
                  <span className={styles.chartLabelSub}>Up to 50 events</span>
                </span>
              </div>
              <div className={styles.chartColumn}>
                <div className={styles.chartTrack} aria-hidden="true">
            ...
            <p className={styles.pricingNote}>
              At around 30 events a year, Gatherwise Professional is $59/mo and
              Aisle Planner is $164.99/mo — about $1,272 a year more. All figures
      ...
      <section id="trial" className={styles.cta}>
        <div className={styles.ctaInner}>
          ...
          <p className={styles.ctaText}>
            Effortless event planning starts here. Bring one live event over and
            see how it feels.
          </p>
      ...
      <footer className={styles.footer}>
        <span>
          © 2026 Gatherwise. Aisle Planner is a trademark of its respective owner;
