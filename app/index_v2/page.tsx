...
// Subtle info tooltip for the seat line on the pricing cards. CSS-only (see
// .gw-info in index_v2.css); tabindex makes it reachable by keyboard and tap.
const SEAT_INFO = `<span class="gw-info" tabindex="0" role="button" aria-label="Additional seats: about $10/mo each, admin or team member"><svg viewBox="0 0 256 256" width="14" height="14" fill="currentColor" aria-hidden="true" focusable="false"><path d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm0,192a88,88,0,1,1,88-88A88.1,88.1,0,0,1,128,216Zm16-40a8,8,0,0,1-8,8,16,16,0,0,1-16-16V128a8,8,0,0,1,0-16,16,16,0,0,1,16,16v40A8,8,0,0,1,144,176ZM112,84a12,12,0,1,1,12,12A12,12,0,0,1,112,84Z"></path></svg><span class="gw-info__tip" role="tooltip">Need more seats? Additional seats are ~$10/mo each, admin or team member.</span></span>`;
...
<main id="main">
  ...
  <section id="pricing" style="background: var(--gw-parchment); padding: var(--gw-section-y) var(--gw-gutter)">
    <div style="max-width: 1180px; margin: 0 auto">
      ...
      <div style="display: grid; gap: 20px; grid-template-columns: repeat(auto-fit, minmax(272px, 1fr)); margin: clamp(30px, 4vw, 44px) 0 0; align-items: stretch">
        ...
        <div style="background: var(--gw-cream); border: 1.5px solid var(--gw-gold); border-radius: 12px; box-shadow: 0 30px 70px -44px rgb(var(--gw-ink-rgb) / 0.55); padding: clamp(26px, 2.8vw, 34px); display: flex; flex-direction: column; gap: 20px">
          ...
          <ul style="list-style: none; margin: 0; padding: 20px 0 0; border-top: 1px solid rgb(var(--gw-ink-rgb) / 0.1); display: grid; gap: 12px">
            ...
            <li style="display: flex; align-items: center; gap: 10px; font-size: 14.5px; color: var(--gw-ink)">${CHECK}<span>2 admins + 2 team <span style="white-space: nowrap">members ${SEAT_INFO}</span></span></li>
            <li style="display: flex; align-items: center; gap: 10px; font-size: 14.5px; color: var(--gw-ink)">${CHECK}Shared access for clients and team</li>
            <li style="display: flex; align-items: center; gap: 10px; font-size: 14.5px; color: var(--gw-ink)">${CHECK}Timeline creation</li>
            <li style="display: flex; align-items: center; gap: 10px; font-size: 14.5px; color: var(--gw-ink)">${CHECK}Task checklists</li>
            <li style="display: flex; align-items: center; gap: 10px; font-size: 14.5px; color: var(--gw-ink)">${CHECK}Vendor management</li>
      ...
      <!-- Enterprise — a quieter row under the three plans, not a fourth card. -->
      <div style="display: flex; flex-wrap: wrap; align-items: center; justify-content: space-between; gap: 16px 30px; margin: 20px 0 0; padding: clamp(20px, 2.2vw, 26px) clamp(22px, 2.4vw, 30px); border: 1px solid rgb(var(--gw-ink-rgb) / 0.14); border-radius: 12px">
        <div style="flex: 1 1 420px; min-width: 260px">
          <div style="display: flex; align-items: baseline; gap: 12px; flex-wrap: wrap">
            <span style="font-family: var(--gw-font-display); font-size: 21px; font-weight: 500; line-height: 1.1; color: var(--gw-ink)">Enterprise</span>
            <span style="font-size: 14px; color: var(--gw-muted-soft)">Custom pricing</span>
          </div>
          <p style="font-size: 14.5px; line-height: 1.6; color: var(--gw-muted); margin: 8px 0 0; max-width: 52em; text-wrap: pretty">For larger firms that need it built around them — everything in Elite, plus custom features and workflows and dedicated support and onboarding. Reach out and we'll put together a quote.</p>
        </div>
